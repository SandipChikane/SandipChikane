...
export function normalizeReferralSettingsForm(body = {}) {
  ...
  const next = parseGlobalReferralSettings({
    ...
    defaultFixedPaise: body.referralDefaultFixedRupees != null && body.referralDefaultFixedRupees !== ''
      ? rupeesToPaise(body.referralDefaultFixedRupees)
      : asNonNegativeInt(body.referralDefaultFixedPaise ?? current.defaultFixedPaise),
    defaultPercentBps: body.referralDefaultPercent != null && body.referralDefaultPercent !== ''
      ? percentToBps(body.referralDefaultPercent)
      : asNonNegativeInt(body.referralDefaultPercentBps ?? current.defaultPercentBps),
