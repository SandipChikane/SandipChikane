...
export async function dispatchAdmin({ req, method, path, query, body }) {
  ...
  switch (`${method} ${action}`) {
    ...
    case 'GET landing':
      return adminHandlers.landing(req, body, 'GET');
    case 'POST landing':
      return adminHandlers.landing(req, body, 'POST');
    case 'GET audit':
      return adminHandlers.audit(req);
    case 'GET referrals':
      return adminHandlers.referralOverview(req);
    case 'POST referral-reverse':
      return adminHandlers.reverseCommission(req, body);
    case 'POST referral-withdrawal':
      return adminHandlers.updateWithdrawal(req, body);
    case 'GET withdrawal':
      return adminHandlers.withdrawalDetail(req, query);
    case 'GET referral-notices':
      return adminHandlers.referralNotices(req);
    case 'POST referral-mature':
      return adminHandlers.matureCommissions(req);
    default:
