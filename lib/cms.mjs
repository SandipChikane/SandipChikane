...
function mapLesson(lesson = {}) {
  return {
    ...
    allowDownload: lesson.allow_download === true || lesson.allowDownload === true || lesson.allowDownload === 'true',
        ...
        for (const [moduleIndex, module] of (section.modules || []).entries()) {
          ...
          for (const [lessonIndex, lesson] of (module.lessons || []).entries()) {
            const savedLesson = await upsertRow('course_lessons', {
              ...
              allow_download: lesson.allowDownload === true || lesson.allowDownload === 'true',
